...
guestname.forEach((guest) =>
  console.log(chalk.blue(`salam ${chalk.magentaBright(guest)} would you like dinner with me`))
);
...
guestname.forEach((last_two) =>
  console.log(chalk.blue(`lucky ${chalk.magentaBright(last_two)} you are still invite to dinner`))
);
